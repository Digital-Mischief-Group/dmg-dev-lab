  ...
  useEffect(() => {
    ...
    const initParticleImage = () => {
      ...
      const pImageConfig: ParticleImageConfig = {
        particles: {
          array: [],
          density: 2.5, // Lower density for more particles
          color: "#ffffff",
          size: {
            value: 1.2, // Slightly larger particles for better visibility
            random: true,
          },
          movement: {
        ...
        image: {
          ...
          size: {
            canvas_pct: 200, // Reduce to ensure it fits properly
            min_px: 100,
            max_px: 800, // Limit maximum size
          },
        },
        interactions: {
          repulse: {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        <span className="text-sm font-mono">PORTRAIT.PARTICLES</span>
        <motion.button
      ...
      <div className="h-64 w-full bg-[#000000] rounded border border-white/5 overflow-hidden">
        <canvas ref={canvasRef} className="w-full h-full" />
      </div>

      <div className="flex items-center justify-between text-xs">
        <span className="text-white/60 font-mono">HOVER & CLICK TO INTERACT</span>
